...
- `Read` tool calls against any `SKILL.md` file (workspace `project skills/`, user-level `user skills/`, or plugin-installed paths under `host plugin cache/`)
- `dstack_task` prompts that name a skill path
